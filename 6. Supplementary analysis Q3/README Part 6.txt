6. Supplementary analyses for Q3

This folder describes the supplementary analyses for question 3.

It contains the following files:

SIX_Supplementary_Q3.R - code file for running analyses
...
These latter five datafiles contain the full dataset from all three experiments (Kempel, Muller, Haueser). The datasets collectively have the following relevant columns:
