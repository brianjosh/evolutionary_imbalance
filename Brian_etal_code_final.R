...
#as described in the Supporting Information then follow. See the Supporting Information file (.docx) for 
#full details. Note the 'Species origin' and 'Hnd' supplementary analyses are included in Main text
#Question 1 and 2 analyses.

#Full contents:
#Main text Question 1: Line 52
#Main text Question 2: Line 1422
#Main text Question 3: Line 3777
#Supplementary analysis K+M models: Line 3944
#Supplementary analysis K+H models: Line 4612
#Supplementary analysis SC models: Line 5394
#Supplementary analysis Structural Equation Models: Line 6954
...
#For each model, two versions run: 
